...
('2025-06-20', '09:00:00', '13:00:00'),
('2025-06-21', '14:00:00', '18:00:00'),
('2025-06-22', '08:00:00', '12:00:00');

-- === UC3: GESTIRE IL PERSONALE ===
...
-- Staff availability (linked by tax_code)
CREATE TABLE IF NOT EXISTS Availabilities (
    staff_tax_code TEXT,
    date TEXT,
    is_available BOOLEAN,
    FOREIGN KEY (staff_tax_code) REFERENCES StaffMembers(tax_code)
);

-- Staff assignments to events or roles
